  ...
  return (
    <View style={styles.component}>
      <View style={styles.header}>
        <Pressable
          onPress={() => setActiveTav(1)}
          style={activeTab === 1 ? styles.tabColor : styles.inc}>
          <Text
            style={activeTab === 1 ? styles.textActive : styles.textNotActive}>
            Income
          </Text>
        </Pressable>
        <Pressable
          onPress={() => setActiveTav(2)}
          style={activeTab === 2 ? styles.tabColor : styles.exp}>
          <Text
            style={activeTab === 2 ? styles.textActive : styles.textNotActive}>
            Expense
          </Text>
        </Pressable>
      </View>
      <View style={styles.body}>
        <View style={styles.fields}>
          ...
          <Dropdown
            data={activeTab === 1 ? incomeData : expenceData}
        ...
        <View style={styles.fields}>
          ...
          <TextInput
            ...
            value={amount}
            onChangeText={text => handleOnChane(text)}
